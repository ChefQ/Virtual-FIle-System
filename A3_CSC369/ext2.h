...
#define PATH_MAX 256 // not sure what max path can be
/* The ext2 block size used in the assignment. */
#define EXT2_BLOCK_SIZE 1024
#define BLOCK_OFFSET(block , BASE_OFFSET  ) (BASE_OFFSET + (block-1)*EXT2_BLOCK_SIZE) // reference: http://cs.smith.edu/~nhowe/262/oldlabs/ext2.html
/*
